    ...
    return (
        <nav
            className={`fixed top-4 left-4 right-4 max-w-7xl mx-auto z-50 transition-all duration-300 rounded-2xl ${
                isScrolled
                    ? 'bg-white/70 dark:bg-slate-950/70 backdrop-blur-xl shadow-lg border border-zinc-200/50 dark:border-zinc-800/50'
                    : 'bg-transparent'
            }`}
        >
                            ...
                            >
                                ...
                                {isActive(link.path) && (
                                    <motion.div
                                        ...
                                        className="absolute inset-0 bg-zinc-100 dark:bg-zinc-800/60 rounded-lg border border-cyan-500/20"
            ...
            <AnimatePresence>
                {isMobileMenuOpen && (
                    <motion.div
                        ...
                        className="md:hidden bg-white/95 dark:bg-slate-950/95 backdrop-blur-xl shadow-lg overflow-hidden border-t border-zinc-200 dark:border-zinc-800 rounded-b-2xl"
                    >
